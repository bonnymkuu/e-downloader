...
import com.example.myvideo.fragments.WhatsAppImagesFragment;
import com.example.myvideo.fragments.WhatsAppSavedFragment;
import com.example.myvideo.fragments.WhatsAppVideosFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        } else if (id == R.id.youtubeExtract) {
            Intent intent = new Intent(MainActivity.this, SearchActivity.class);
            startActivity(intent);
        } else if (id == R.id.tiktok) {
            Toast.makeText(this, "Will be implemented soon", Toast.LENGTH_SHORT).show();
