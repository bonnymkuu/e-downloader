...
public class VideoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(view -> share(videoPath));

        download.setOnClickListener(view -> copyFileOrDirectory(videoPath, path));

        repost.setOnClickListener(view -> repost(videoPath, packageName));
